...
public class PersistentLoginsRecord extends UpdatableRecordImpl<PersistentLoginsRecord>
    implements Record4<String, String, String, LocalDateTime> {

  private static final long serialVersionUID = 383528293;
  ...
  @Override
  public PersistentLoginsRecord values(
      String value1, String value2, String value3, LocalDateTime value4) {
    value1(value1);
    value2(value2);
    value3(value3);
    value4(value4);
  ...
  public PersistentLoginsRecord(
      String username, String series, String token, LocalDateTime lastUsed) {
    super(PersistentLogins.PERSISTENT_LOGINS);
